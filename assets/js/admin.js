            ...
            if (inp_swp_key.length && inp_swp_endpoint.length) {
                ...
                $.ajax({
                    ...
                    if (true === response.status) {
                        ...
                        swp_status_indicator.addClass('good');
                        swp_status_indicator.removeClass('bad');
                    }

                    swp_status_field.val(response.status);

                }).fail(function(response) {
                    if (true !== response.status) {
                        swp_status_indicator.addClass('tested');
                        swp_status_indicator.addClass('bad');
                        swp_status_indicator.removeClass('good');
                    }

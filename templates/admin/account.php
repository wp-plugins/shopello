<div class="wrap">
    ...
    <form method="post" action="options.php" id="swp_options_form">
        ...
        <table class="form-table compact">
			<tr valign="top">
				<th scope="row">
					<label for="swp_api_key">API-nyckel</label></th>
				<td>
		            <input type="text" id="swp_api_key" name="swp_api_key" value="<?php echo get_option('swp_api_key'); ?>" /></td>
			</tr>

			<tr valign="top">
				<th scope="row">
					<label for="swp_api_endpoint">API-domän * </label></th>
				<td>
		            <input type="text" id="swp_api_endpoint" name="swp_api_endpoint" value="<?php echo get_option('swp_api_endpoint'); ?>" /></td>
			</tr>

			<tr valign="top">
				<th scope="row">
					<label for="swp_api_endpoint">Testa inställningar</label></th>
				<td>

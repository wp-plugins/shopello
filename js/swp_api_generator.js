...
SWP_Api_Generator.prototype._load_parse_url = function( reload ){
	...
	if( allowed_params.contains(key)) {
	    ...
	    if( ['categories','brands'].contains(key) ) val = val.split(",").map(Number);
...
/*
  Set URL. Eigher hashbang style OR get param style, depending on browser
*/
